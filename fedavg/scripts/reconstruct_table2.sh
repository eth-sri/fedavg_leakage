...
EP=('1' '5' '10')
ALG=('aaai_en_only' 'aaai_st_only' 'aaai_avg_only')
BS='5'
ST='10'

for i in "${!EP[@]}"; do
	for j in "${!ALG[@]}"; do
		echo "${ALG[j]} ${BS}x${ST}x${EP[i]}"
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.01 \
											        ...
											        --defense_inner_iterations=1 --defense_dilation=500 --max_batch $((BS * ST)) --n_attack=100 --epochs ${EP[i]} --rand_batch -reorder_prior l2_avg --reg_reorder 1000 \
											        -res_label ${ALG[j]} -label_samp 3000 \
                                                                                                $neptune
	done
done
...
for i in "${!BS[@]}"; do
	for j in "${!ALG[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.01 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --max_batch $((BS[i] * ST[i])) --n_attack=100 --epochs ${EP} --rand_batch -reorder_prior l2_avg --reg_reorder 1000 \
											        -res_label ${ALG[j]} -label_samp 3000 \
                                                                                                $neptune
	done
done
...
for i in "${!EP[@]}"; do
	for j in "${!ALG[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.03 \
												...
												--attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
												--defense_inner_iterations=1 --defense_dilation=500 --n_attack=100 --epochs ${EP[i]} --rand_batch -reorder_prior l2_avg --reg_reorder 1000 \
												-res_label ${ALG[j]} -label_samp 3000 \
                                                                                                $neptune
	done
done
...
for i in "${!BS[@]}"; do
	for j in "${!ALG[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.03 \
												...
												--attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
												--defense_inner_iterations=1 --defense_dilation=500 --n_attack=100 --epochs ${EP} --rand_batch -reorder_prior l2_avg --reg_reorder 1000 \
												-res_label ${ALG[j]} -label_samp 3000 \
                                                                                                $neptune
	done
done
