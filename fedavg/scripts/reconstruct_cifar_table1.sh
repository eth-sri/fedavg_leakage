...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full --attack --attack_loss cos --acc_loss_factor=0.03 \
												...
												--vis_step=200 --vis_dir FINAL_FULL_CIFAR100_none_${EP}_${BS[i]}_${ST[i]} --visualize \
											        $neptune \
												--neptune-label FINAL_FULL_CIFAR100_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.03 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --n_attack=100 --epochs ${EP} --rand_batch \
												--vis_step=200 --vis_dir FINAL_FULL_MANY_NOPRIOR_CIFAR100_none_${EP}_${BS[i]}_${ST[i]} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_FULL_MANY_NOPRIOR_CIFAR100_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg none --attack --attack_loss cos --acc_loss_factor=0.03 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --n_attack=100 --epochs ${EP} --rand_batch \
												--vis_step=200 --vis_dir FINAL_NONE_CIFAR100_none_${EP}_${BS[i]}_${ST[i]} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_NONE_CIFAR100_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg none_epoch --attack --attack_loss cos --acc_loss_factor=0.03 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --n_attack=100 --epochs ${EP} --rand_batch \
												--vis_step=200 --vis_dir FINAL_NONE_EPOCH_CIFAR100_none_${EP}_${BS[i]}_${ST[i]} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_NONE_EPOCH_CIFAR100_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.03 \
												...
												--vis_step=200 --vis_dir FINAL_FULL_MANY_PRIOR_CIFAR100_none_${EP}_${BS[i]}_${ST[i]} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_FULL_MANY_PRIOR_CIFAR100_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full --attack --attack_loss cos --acc_loss_factor=0.03 \
												...
												--vis_step=200 --vis_dir FINAL_FULL_CIFAR100_none_${EP[i]}_${BS}_${ST} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_FULL_CIFAR100_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.03 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --n_attack=100 --epochs ${EP[i]} --rand_batch \
												--vis_step=200 --vis_dir FINAL_FULL_MANY_NOPRIOR_CIFAR100_none_${EP[i]}_${BS}_${ST} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_FULL_MANY_NOPRIOR_CIFAR100_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg none --attack --attack_loss cos --acc_loss_factor=0.03 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --n_attack=100 --epochs ${EP[i]} --rand_batch \
												--vis_step=200 --vis_dir FINAL_NONE_CIFAR100_none_${EP[i]}_${BS}_${ST} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_NONE_CIFAR100_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg none_epoch --attack --attack_loss cos --acc_loss_factor=0.03 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --n_attack=100 --epochs ${EP[i]} --rand_batch \
												--vis_step=200 --vis_dir FINAL_NONE_EPOCH_CIFAR100_none_${EP[i]}_${BS}_${ST} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_NONE_EPOCH_CIFAR100_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=19.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.03 \
												...
												--vis_step=200 --vis_dir FINAL_FULL_MANY_PRIOR_CIFAR100_none_${EP[i]}_${BS}_${ST} --visualize \
                                                                                                $neptune \
												--neptune-label FINAL_FULL_MANY_PRIOR_CIFAR100_none_${EP[i]}_${BS}_${ST}
done
