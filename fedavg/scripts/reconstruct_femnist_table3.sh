...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full --attack --attack_loss cos --acc_loss_factor=0.01 \
												...
												--vis_step=200 --vis_dir FINAL_COMPLETE_FULL_FEMNIST_none_${EP[i]}_${BS}_${ST} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_FULL_FEMNIST_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.01 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --max_batch $((BS * ST)) --n_attack=100 --epochs ${EP[i]} --rand_batch \
												--vis_step=200 --vis_dir FINAL_COMPLETE_FULL_MANY_NOPRIOR_FEMNIST_none_${EP[i]}_${BS}_${ST} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_FULL_MANY_NOPRIOR_FEMNIST_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg none --attack --attack_loss cos --acc_loss_factor=0.01 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --max_batch $((BS * ST)) --n_attack=100 --epochs ${EP[i]} --rand_batch \
												--vis_step=200 --vis_dir FINAL_COMPLETE_NONE_FEMNIST_none_${EP[i]}_${BS}_${ST} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_NONE_FEMNIST_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg none_epoch --attack --attack_loss cos --acc_loss_factor=0.01 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --max_batch $((BS * ST)) --n_attack=100 --epochs ${EP[i]} --rand_batch \
												--vis_step=200 --vis_dir FINAL_COMPLETE_NONE_EPOCH_FEMNIST_none_${EP[i]}_${BS}_${ST} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_NONE_EPOCH_FEMNIST_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!EP[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.01 \
												...
												--vis_step=200 --vis_dir FINAL_COMPLETE_FULL_MANY_PRIOR_FEMNIST_none_${EP[i]}_${BS}_${ST} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_FULL_MANY_PRIOR_FEMNIST_none_${EP[i]}_${BS}_${ST}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full --attack --attack_loss cos --acc_loss_factor=0.01 \
												...
												--vis_step=200 --vis_dir FINAL_COMPLETE_FULL_FEMNIST_none_${EP}_${BS[i]}_${ST[i]} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_FULL_FEMNIST_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.01 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --max_batch $((BS[i] * ST[i])) --n_attack=100 --epochs ${EP} --rand_batch \
												--vis_step=200 --vis_dir FINAL_COMPLETE_FULL_MANY_NOPRIOR_FEMNIST_none_${EP}_${BS[i]}_${ST[i]} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_FULL_MANY_NOPRIOR_FEMNIST_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg none --attack --attack_loss cos --acc_loss_factor=0.01 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --max_batch $((BS[i] * ST[i])) --n_attack=100 --epochs ${EP} --rand_batch \
												--vis_step=200 --vis_dir FINAL_COMPLETE_NONE_FEMNIST_none_${EP}_${BS[i]}_${ST[i]} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_NONE_FEMNIST_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg none_epoch --attack --attack_loss cos --acc_loss_factor=0.01 \
											        ...
											        --attack_repeated_init=1 --attack_total_variation=1.0 --attack_l2_reg=0 --attack_accuracy_reg=0 --defense_attack_iterations=2000 \
											        --defense_inner_iterations=1 --defense_dilation=500 --max_batch $((BS[i] * ST[i])) --n_attack=100 --epochs ${EP} --rand_batch \
												--vis_step=200 --vis_dir FINAL_COMPLETE_NONE_EPOCH_FEMNIST_none_${EP}_${BS[i]}_${ST[i]} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_NONE_EPOCH_FEMNIST_none_${EP}_${BS[i]}_${ST[i]}
done
...
for i in "${!BS[@]}"; do
		...
		XLA_PYTHON_CLIENT_PREALLOCATE=false python3 train_fed.py --delta=20.0 --n_clients=1 --n_steps=100000 --l2_reg=0.0 --fedavg full_many --attack --attack_loss cos --acc_loss_factor=0.01 \
												...
												--vis_step=200 --vis_dir FINAL_COMPLETE_FULL_MANY_PRIOR_FEMNIST_none_${EP}_${BS[i]}_${ST[i]} --visualize \
												-res_label aaai_avg_full -label_samp 3000 \
                                                                                                $neptune \
												--neptune-label FINAL_COMPLETE_FULL_MANY_PRIOR_FEMNIST_none_${EP}_${BS[i]}_${ST[i]}
done
